  ...
  return (
    <>
      <PageHeader
        ...
        description="View and manage fabric rolls that are currently in the Lamination stage."
      />

      <Card>
        <CardHeader>
          <CardTitle>Available Laminated Stock ({stockRows.length})</CardTitle>
        </CardHeader>
        <CardContent>
          {stockRows.length === 0 ? (
            <EmptyState title="No stock found" description="There are currently no active rolls in the Lamination stage." />
          ) : (
