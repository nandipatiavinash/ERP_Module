...
export default async function OffsetPrintingConsumptionPage({
  ...
  return (
    <>
      <PageHeader
        title="Offset Printing Raw Material Consumption"
        description="Log and monitor the consumption of raw materials (inks, chemicals, printing plates) in the Offset Printing process."
      />
