  ...
  return (
    <>
      <PageHeader
        ...
        description="View and manage fabric rolls that are currently in the Offset Printing stage."
      />

      <Card>
        <CardHeader>
          <CardTitle>Available Offset Printed Stock ({stockRows.length})</CardTitle>
        </CardHeader>
        <CardContent>
          {stockRows.length === 0 ? (
            <EmptyState title="No stock found" description="There are currently no active rolls in the Offset Printing stage." />
          ) : (
